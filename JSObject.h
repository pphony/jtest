...
{
  // kt acquire the stored value
//		std::map<std::pair<JSObject*, CString>, JSValue>::iterator it = shadow.find(std::make_pair(this, propertyName.uid()->utf8()));	
//		if (it != shadow.end())
//		{
//			JSValue v = it->second;
//			slot.setValue(this, 0, v);
//			return true;
//		}
...
////          if (!value.isFunction())
//            shadow2[value] = std::make_pair(this, propertyName.uid()->utf8());
          return true;
        }
